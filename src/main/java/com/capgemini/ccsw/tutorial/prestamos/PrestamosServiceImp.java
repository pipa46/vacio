...
public class PrestamosServiceImp implements PrestamosService 
{
   ...
   public  void save(Long id, PrestamosDto data)
   {
	  ...
	  Page<PrestamosDto>prestamo=prestamosController.findPage(dto);
      boolean guardar=false;
        
         if(prestamo.stream().anyMatch(k->k.getNombreCliente().getNombre().equals(data.getNombreCliente().getNombre())))
   		{
   			String t="";
   			int indice=0;
      ...
      if((guardar_3==true && guardar_2==true  && guardar==true)||(guardar_3==false && guardar_2==false  && guardar==false) )
   ...
   public void delete(Long id)
   {
    ...
    {
      return(List<Prestamos>)this.prestamosRepository.findAll();    	
    }
    @Override
